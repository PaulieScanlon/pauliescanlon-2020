...
React, Gatsby, JavaScript, TypeScript/Flow, styled-components, Theme UI, Storybook, TDD (Jest/Enzyme/React Testing Library) and a tiny bit of Apollo/GraphQL, Node and FaunaDB
